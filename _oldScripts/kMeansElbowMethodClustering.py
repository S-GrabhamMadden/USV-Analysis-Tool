...
#k means time
i = 0
for representationLayer in realnumbers:
	
	clusterData = numpy.array(representationLayer).reshape(-1,1)
	...
	for k in K:
		...
		clusters, centroids = kmeans1d.cluster(representationLayer, k)
